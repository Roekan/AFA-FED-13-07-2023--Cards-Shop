    ...
    <>
      ...
      <Container >
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav>
            <Nav.Link className='d-flex align-items-center justify-content-center icon-header my-1 mx-1' href="#user">
            ...
            <Nav.Link className='d-flex align-items-center justify-content-center icon-header my-1 mx-1' href="#favorites">
            ...
            <Nav.Link className='d-flex align-items-center justify-content-center icon-header my-1 mx-1' href="#cart">
