          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav>
              {userTypeLogin==="admin"
                  ...
                  <span className='d-flex align-items-center justify-content-center number-info-header'>{userFavorites.length>0 && userFavorites.length}</span>
                  </Nav.Link>
                  ...
                  <span className='d-flex align-items-center justify-content-center number-info-header'>{userPurchases.length>0 && userPurchases.length}</span>
                  </Nav.Link>
