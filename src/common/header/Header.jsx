          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav>
              {userTypeLogin === "admin" ? (
                <>
                  <Nav.Link
                    className="d-flex align-items-center justify-content-center icon-header my-1 mx-1"
                    onClick={() => {
                      navigate("/");
                    }}
                    alt="Home"
                  ...
                  >
                    ...
                    {userFavorites.length > 0 && (
                      <span className="d-flex align-items-center justify-content-center number-info-header">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M4 22a8 8 0 1 1 16 0H4Zm8-9c-3.315 0-6-2.685-6-6s2.685-6 6-6s6 2.685 6 6s-2.685 6-6 6Z"></path>
                    </svg>
                  </Nav.Link>
                  <Nav.Link
                    className="d-flex align-items-center justify-content-center icon-header my-1 mx-1"
                ...
                <>
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M4 22a8 8 0 1 1 16 0h-2a6 6 0 0 0-12 0H4Zm8-9c-3.315 0-6-2.685-6-6s2.685-6 6-6s6 2.685 6 6s-2.685 6-6 6Zm0-2c2.21 0 4-1.79 4-4s-1.79-4-4-4s-4 1.79-4 4s1.79 4 4 4Z"></path>
                    </svg>
                  </Nav.Link>
                </>
              )}
