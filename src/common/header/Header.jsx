          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Nav>
              {userTypeLogin==="admin"
                  ?
                  <>
                  <Link className='d-flex align-items-center justify-content-center icon-header my-1 mx-1' to="/" alt="Home">
                  ...
                  <Link className='d-flex align-items-center justify-content-center icon-header my-1 mx-1' to="favorites" alt="Favoritos">
                  ...
                  <Link className='d-flex align-items-center justify-content-center icon-header my-1 mx-1' to="cart" alt="Carrito">
                  ...
                  <Link className='d-flex align-items-center justify-content-center icon-header my-1 mx-1' to="user" alt="Usuario">
                  ...
                  <Link className='d-flex align-items-center justify-content-center icon-header my-1 mx-1' to="listusers" alt="Usuario">
                  ...
                  :
                  <>
                  <Link className='d-flex align-items-center justify-content-center icon-header my-1 mx-1' to="login" alt="Usuario">
