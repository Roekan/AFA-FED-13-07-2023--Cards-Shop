    ...
    <>
      <Container className="box-cards-favorites">
        <Row className="d-flex align-items-top justify-content-center py-3">
          <h2 className="d-flex align-items-top justify-content-center py-3 title-favorites">
            Favoritos
          </h2>
        </Row>
        <Row className="d-flex align-items-top justify-content-center py-3 box-card-home">
          {favorites.length > 0 &&
            favorites.map((card) => {
              return (
                <Col
          ...
          {favorites.length <= 0 && (
            <Col className="my-2 d-flex align-items-center justify-content-center not-found-favorites">
              <h2>No se han guardado favoritos</h2>
            </Col>
          )}
